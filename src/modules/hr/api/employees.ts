...
const employeeSelection = `id, employee_number, legal_name, company_email, personal_email, work_phone, gender, date_of_birth, archived_at, employee_confidential_profiles(national_id,gross_salary,currency_code,custom_overtime_rate,payment_method,mobile_money_number,bank_name,account_number,sort_code,tin_number,nssf_number,employee_tax_type,pct_month_worked,wht_rate), employment_periods(start_date, end_date, department_id, job_title_id, employment_type, contract_type, probation_end_date, probation_status, departments(name), job_titles(name))`
