export const employeeTemplateColumns = [
  ...
  { key: 'currency', label: 'Currency' }, { key: 'custom_overtime_rate', label: 'Custom Overtime Rate / Hr' }, { key: 'mobile_money_number', label: 'Mobile Money Number' },
...
export async function downloadEmployeeTemplate() {
  ...
  const example = ['Sarah Nakato', 'CM91010002TQMZ', 'sarah@company.com', 'sarah@gmail.com', '+256700000000', 'female', '1990-01-31', 'Operations', 'Store Manager', 'full_time', '2026-07-11', 'permanent', '', '', 'not_applicable', 1500000, 'UGX', '', '0772000000', 'Stanbic Bank', '9030012345678', 'EQBLUGKA', 'AC002', '1036914121', '1997050295506', 'local', 100, 6]
  ...
  const instructions = XLSX.utils.aoa_to_sheet([
    ...
    ['Contract Type', 'permanent, fixed_term, casual, internship, consultancy'], ['Employee Tax Type', 'local, global, contractor, exempt'],
