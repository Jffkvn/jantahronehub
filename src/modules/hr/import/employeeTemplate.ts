export const employeeTemplateColumns = [
  ...
  { key: 'gender', label: 'Gender' }, { key: 'date_of_birth', label: 'Date of Birth' }, { key: 'department', label: 'Department' }, { key: 'job_title', label: 'Position / Job Title' }, { key: 'pay_grade', label: 'Pay Grade' },
...
export async function downloadEmployeeTemplate() {
  ...
  const example = ['Sarah Nakato', 'CM91010002TQMZ', 'sarah@company.com', 'sarah@gmail.com', '+256700000000', 'female', '1990-01-31', 'Operations', 'Store Manager', 'G1', 'full_time', '2026-07-11', 'permanent', '', '', 'not_applicable', 1500000, 'UGX', '', 'bank', '0772000000', 'Stanbic Bank', '9030012345678', 'EQBLUGKA', 'AC002', '1036914121', '1997050295506', 'local', 100, 6]
  ...
  const instructions = XLSX.utils.aoa_to_sheet([
    ...
    ['Contract Type', 'permanent, fixed_term, casual, internship, consultancy'], ['Pay Grade', 'Use an active OneHub pay-grade code or name.'], ['Payment Method', 'bank, mobile_money, cash. Bank requires bank name and account number; mobile_money requires a phone number.'], ['Employee Tax Type', 'local, global, contractor, exempt'],
