...
- Do not edit an already-hosted migration as the only correction. Add migrations `0052` onward.
...
**Files:**
- Create: `supabase/migrations/0052_harden_cash_authorization.sql`
...
7. Apply migration `0052` to the Antigravity project.
...
**Files:**
- Create: `supabase/migrations/0053_enforce_cash_accounting.sql`
- Modify: `supabase/tests/cash_advances.sql`
...
8. Apply `0053`, rerun pgTAP, unit tests and `git diff --check`.
9. Commit: `fix: enforce cash advance reconciliation invariants`.

## Task 4: Repair Inventory State Transitions and Receiving

**Files:**
- Create: `supabase/migrations/0054_harden_inventory_workflows.sql`
...
10. Apply `0054`, rerun inventory/approval pgTAP and linked lint.
11. Commit: `fix: make inventory transitions atomic and idempotent`.

## Task 5: Add Explicit Custody and Safe QR Fulfilment

**Files:**
- Create: `supabase/migrations/0055_add_asset_custody.sql`
- Modify: `supabase/tests/inventory_workflow.sql`
...
7. Apply `0055`; run inventory pgTAP and the focused component test.
...
- Create: `supabase/migrations/0056_fix_report_permissions.sql`
...
10. Apply `0056`; run report unit tests and pgTAP.
...
- Create if hosted behavior changes: `supabase/migrations/0057_fix_historical_employee_reconciliation.sql`
...
8. If database behavior changes, apply additive migration `0057` to the Antigravity project.
...
**Files:**
- Create: `supabase/migrations/0058_harden_notification_delivery.sql`
...
10. Apply `0058`; deploy the Edge Function only after secrets are configured outside Git.
